    ...
    return (
        <div className={cn(
            ...
            <div className={cn(
                ...
                "flex flex-col h-full rounded-xl justify-between pl-5 py-5 pr-10 bg-background-90"
            )}>
                <div className="flex flex-col flex-1">
                    ...
                    {label === "PRO" ? (
                        <span className='bg-gradient-to-r mt-2 from-indigo-500 via-purple-500 font-bold to-pink-500 bg-clip-text text-transparent'>Smart AI</span>
                    ) : (
