          ...
          <div className="container px-4 py-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="h-8 w-8 rounded-lg bg-white flex text-black items-center justify-center font-bold">
                  li
                </div>
              ...
              <Button variant="outline" className="text-primary border-blue-400">
              {/* <Button color='black' className="bg-white text-primary"> */}
